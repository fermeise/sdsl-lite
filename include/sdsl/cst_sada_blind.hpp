...
*/
/*! \file cst_sada_blind.hpp
    \brief cst_sada.hpp contains an implementation of
    a blind variant of Sadakane's CST.
    \author Christian Ocker
*/
#ifndef INCLUDED_SDSL_CST_SADA_BLIND
#define INCLUDED_SDSL_CST_SADA_BLIND
...
class cst_sada_blind
{
    ...
    private:
        ...
        void copy(const cst_sada_blind& cst)
        {
            m_csa           = cst.m_csa;
...
//! Swap method for cst_sada
        /*! The swap method can be defined in terms of assignment.
            ...
            \param cst cst_sada_blind to swap.

            Required for the Assignable Conecpt of the STL.
          */
        void swap(cst_sada_blind& cst)
        {
            if (this != &cst) {
...
//! Assignment Operator.
         ...
         */
        cst_sada_blind& operator=(const cst_sada_blind& cst)
        {
            if (this != &cst) {
                copy(cst);
            }
...
//! Assignment Move Operator.
         ...
         *    Required for the Assignable Concept of the STL.
         */
        cst_sada_blind& operator=(cst_sada_blind&& cst)
        {
            if (this != &cst) {
...
//! Calculate the parent node of a node v in the suffix tree.
...
//! Calculate the parent node of a node v in the binary tree.
         ...
         *     \f$ \Order{1}\f$
         */
        cst_node_child_proxy<cst_sada_blind> children(node_type v) const
        {
